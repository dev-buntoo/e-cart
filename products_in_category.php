<?php
    ...
    $sql = "SELECT * FROM category_tbl WHERE id = $cat_id";
    $cat = mysqli_fetch_array(mysqli_query($conn  , $sql));
    ?>
<!DOCTYPE html>
<html>
    ...
    <div class="product-listing">
        <div class="container mt-5">
            <div class="row text-center">
                <div class="col-md-12">
                    <p>Showing Products In Category "<?php echo htmlentities($cat['name']) ?>"</p>
                </div>
            </div>
...
<?php
$sql = "SELECT * FROM product_tbl WHERE promo = '0' && cat_id = $cat_id ORDER BY RAND()";
...
?>
                <div class="col-md-3 product-box">
                        ...
                        <div class="product">
                        <a class='text-black-50' href="pro_detail.php?product=<?php echo$product['id']; ?>">
