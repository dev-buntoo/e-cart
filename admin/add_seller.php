    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="mt-4">Add New Seller</h3>
                    <hr>
                    <div class="container" style="padding: 70px;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="offset-5">
                            <button onclick="confirm('Are you sure you want to add a new Seller');" type="submit" class="btn btn-outline-success" name="add_seller">Add Seller</button>
                            </div>
                        </form>
                    </div>
