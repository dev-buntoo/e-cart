...
$id = $_GET['id'];
$sql = "SELECT * FROM seller_tbl WHERE id = '$id'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h4 class="mt-4">Update Seller</h3>
                    <hr>
                    <div class="container" style="padding: 70px;">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="offset-5">
                                <button onclick="confirm('Are you sure ?');" class="btn btn-outline-success" name="update_seller" value="<?php echo htmlentities($row['id']); ?>">Update Seller</button>
                            </div>
                        </form>
                    </div>
