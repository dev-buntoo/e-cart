<header class="masthead" style="background-image: linear-gradient(rgba(14,14,14,0.38), #a2a2a2),  url(&quot;assets/img/bg.png&quot;);">
            ...
            <div class="input-group-append"><button class="btn btn-primary" type="button">Search</button></div>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h1 class="brand-heading">The Online SuperStore</h1>
                        <p class="intro-text">WHERE YOU FIND EVERY THING</p>
                    </div>
                </div>
            </div>
        </div>
