                ...
                <li class="nav-item nav-link js-scroll-trigger" role="presentation" style="padding-top: 16px;">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            ...
                            ?>
                            <a class="dropdown-item text-dark" role="presentation" href="products_in_category.php?<?php echo $category['id'] ?>"><?php echo $category['name'] ?></a>
                                <?php } ?>
                        </div>
                    </div>
                </li>
                <li class="nav-item nav-link js-scroll-trigger" role="presentation" style="padding-top: 16px;">
                    <div class="nav-item dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Stores</a>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="#" style="color: rgb(0,0,0);">First Item</a></div>
                    </div>
                </li>
                <li class="nav-item nav-link js-scroll-trigger" role="presentation"><a class="nav-link js-scroll-trigger" href="#download">About</a></li>
                <li class="nav-item nav-link js-scroll-trigger" role="presentation"><a class="nav-link js-scroll-trigger" href="#download">Contact Us</a></li>
            </ul>
