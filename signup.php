...
<header class="contact-us-top" style="background-image: linear-gradient(rgba(14,14,14,0.66), rgba(14,14,14,0.66)),  url(&quot;assets/img/bg.png&quot;);">
    ...
    <div class="contact-clean">
        <form method="post">
            ...
            <div class="form-group"><input class="form-control form-control-input" type="city" name="city" placeholder="City" required></div>
            ...
            <div
                class="form-group"><textarea class="form-control form-control-input" name="address" rows="14" placeholder="Address" required></textarea></div><button class="btn btn-primary btn-block btn-cus" type="submit" style="background-color: rgba(217,220,225,0);" name="signup">SignUp</button></form>
    </div>
